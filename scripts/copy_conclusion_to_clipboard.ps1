# copy_conclusion_to_clipboard.ps1
# Copies blog_conclusion.html to the Windows clipboard in CF_HTML format (HTML Format).
# Uses manually calculated UTF-8 byte offsets as required by the CF_HTML spec.

Add-Type -AssemblyName System.Windows.Forms

$htmlFile = Join-Path $PSScriptRoot "..\docs\blog\substack\blog_conclusion.html"
