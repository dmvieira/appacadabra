# copy_part10_to_clipboard.ps1
# Copies blog_part10.html to the Windows clipboard in CF_HTML format (HTML Format).
# Uses manually calculated UTF-8 byte offsets as required by the CF_HTML spec.

Add-Type -AssemblyName System.Windows.Forms

$htmlFile = Join-Path $PSScriptRoot "..\docs\blog\substack\blog_part10.html"
