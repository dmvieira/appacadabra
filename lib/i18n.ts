...
const translations = {
    en: {
        ...
        onboardingGoogleTitle: 'Sign in with Google 🔐',
        onboardingGoogleBody: 'Link your **Google account** to save your Mana in the cloud. Switch devices without losing credits! Your **spells stay on your device** — safe and private.',
    ...
    pt: {
        ...
        onboardingGoogleTitle: 'Entrar com Google 🔐',
        onboardingGoogleBody: 'Vincule sua **conta Google** para salvar sua Mana na nuvem. Troque de dispositivo sem perder créditos! Seus **feitiços ficam no seu dispositivo** — seguros e privados.',
    ...
    es: {
        ...
        onboardingGoogleTitle: 'Iniciar sesión con Google 🔐',
        onboardingGoogleBody: 'Vincula tu **cuenta de Google** para guardar tu Maná en la nube. ¡Cambia de dispositivo sin perder créditos! Tus **hechizos se quedan en tu dispositivo** — seguros y privados.',
    ...
    fr: {
        ...
        onboardingGoogleTitle: 'Se connecter avec Google 🔐',
        onboardingGoogleBody: 'Liez votre **compte Google** pour sauvegarder votre Mana dans le cloud. Changez d\'appareil sans perdre vos crédits ! Vos **sorts restent sur votre appareil** — sûrs et privés.',
    ...
    de: {
        ...
        onboardingGoogleTitle: 'Mit Google anmelden 🔐',
        onboardingGoogleBody: 'Verknüpfe dein **Google-Konto**, um dein Mana in der Cloud zu speichern. Wechsle das Gerät, ohne Guthaben zu verlieren! Deine **Zauber bleiben auf deinem Gerät** — sicher und privat.',
    ...
    it: {
        ...
        onboardingGoogleTitle: 'Accedi con Google 🔐',
        onboardingGoogleBody: 'Collega il tuo **account Google** per salvare il Mana nel cloud. Cambia dispositivo senza perdere crediti! I tuoi **incantesimi restano sul dispositivo** — sicuri e privati.',
    ...
    ja: {
        ...
        onboardingGoogleTitle: 'Googleでサインイン 🔐',
        onboardingGoogleBody: '**Googleアカウント**を連携してマナをクラウドに保存。デバイスを変えてもクレジットは失われません！**呪文はデバイスに保存** — 安全でプライベート。',
    ...
    zh: {
        ...
        onboardingGoogleTitle: '使用Google登录 🔐',
        onboardingGoogleBody: '关联您的**Google账户**将魔力保存到云端。更换设备不会丢失积分！您的**应用保存在设备上** — 安全私密。',
    ...
    ko: {
        ...
        onboardingGoogleTitle: 'Google로 로그인 🔐',
        onboardingGoogleBody: '**Google 계정**을 연동하여 마나를 클라우드에 저장하세요. 기기를 변경해도 크레딧을 잃지 않습니다! **앱은 기기에 저장** — 안전하고 비공개입니다.',
    ...
    ar: {
        ...
        onboardingGoogleTitle: 'تسجيل الدخول بحساب Google 🔐',
        onboardingGoogleBody: 'اربط **حساب Google** لحفظ المانا في السحابة. غيّر جهازك دون فقدان الرصيد! **تطبيقاتك تبقى على جهازك** — آمنة وخاصة.',
    ...
    hi: {
        ...
        onboardingGoogleTitle: 'Google से साइन इन करें 🔐',
        onboardingGoogleBody: 'माना को क्लाउड में सहेजने के लिए **Google खाता** लिंक करें। डिवाइस बदलें और क्रेडिट न खोएं! आपके **ऐप्स डिवाइस पर रहते हैं** — सुरक्षित और निजी।',
    ...
    ru: {
        ...
        onboardingGoogleTitle: 'Войти через Google 🔐',
        onboardingGoogleBody: 'Привяжите **аккаунт Google** для сохранения Маны в облаке. Меняйте устройство без потери кредитов! Ваши **приложения остаются на устройстве** — в безопасности.',
    ...
    tr: {
        ...
        onboardingGoogleTitle: 'Google ile Giriş Yap 🔐',
        onboardingGoogleBody: 'Mananızı buluta kaydetmek için **Google hesabınızı** bağlayın. Cihaz değiştirin, kredi kaybetmeyin! **Uygulamalarınız cihazınızda kalır** — güvenli ve özel.',
    ...
    nl: {
        ...
        onboardingGoogleTitle: 'Inloggen met Google 🔐',
        onboardingGoogleBody: 'Koppel je **Google-account** om Mana in de cloud op te slaan. Wissel van apparaat zonder krediet te verliezen! Je **apps blijven op je apparaat** — veilig en privé.',
    ...
    pl: {
        ...
        onboardingGoogleTitle: 'Zaloguj się przez Google 🔐',
        onboardingGoogleBody: 'Połącz **konto Google**, aby zapisać Manę w chmurze. Zmień urządzenie bez utraty kredytów! Twoje **aplikacje pozostają na urządzeniu** — bezpieczne i prywatne.',
    ...
    vi: {
        ...
        onboardingGoogleTitle: 'Đăng nhập bằng Google 🔐',
        onboardingGoogleBody: 'Liên kết **tài khoản Google** để lưu Mana lên đám mây. Đổi thiết bị mà không mất tín dụng! **Ứng dụng ở lại trên thiết bị** — an toàn và riêng tư.',
    ...
    th: {
        ...
        onboardingGoogleTitle: 'เข้าสู่ระบบด้วย Google 🔐',
        onboardingGoogleBody: 'เชื่อมต่อ**บัญชี Google** เพื่อบันทึกมานาไว้บนคลาวด์ เปลี่ยนอุปกรณ์โดยไม่สูญเสียเครดิต! **แอปยังอยู่บนอุปกรณ์** — ปลอดภัยและเป็นส่วนตัว',
