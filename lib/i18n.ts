...
const translations = {
    en: {
        ...
        shortcutNudgeText: 'Open directly from your home screen',
        ...
        obConceptPrompt: 'I want a Pomodoro timer with a space theme 🚀',
        ...
        obPowersSubtext: 'Beyond AI, your apps access real features on your phone.',
        obPowerCalendar: 'Calendar',
        obPowerCalendarDesc: 'Creates events and automatic reminders',
        obPowerNotifications: 'Notifications',
        obPowerNotificationsDesc: 'Alerts at the right time',
        obPowerLocation: 'Location',
        obPowerLocationDesc: 'Suggestions based on where you are',
        obPowerBiometrics: 'Biometrics',
        obPowerBiometricsDesc: 'Protect spells with fingerprint or face',
        obPowerShare: 'Share',
        obPowerShareDesc: 'Export and send to friends',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Opens other apps directly',
        obPowerSensors: 'Sensors',
        obPowerSensorsDesc: 'Access compass, accelerometer and more',
        obPowerHealth: 'Health',
        obPowerHealthDesc: 'Steps, calories and fitness data',
        obPowerReceive: 'Receive Data',
        obPowerReceiveDesc: "Appears in 'Share' from other apps",
        obPowerContacts: 'Contacts',
        obPowerContactsDesc: 'Select people from your agenda',
        obPowerDevice: 'Device',
        obPowerDeviceDesc: 'Vibration, language and system info',
    ...
    pt: {
        ...
        shortcutNudgeText: 'Abra direto da tela inicial',
        ...
        obConceptPrompt: 'Quero um timer Pomodoro com tema espacial 🚀',
        ...
        obPowersSubtext: 'Além de IA, seus apps acessam recursos reais do seu celular.',
        obPowerCalendar: 'Calendário',
        obPowerCalendarDesc: 'Cria eventos e lembretes automáticos',
        obPowerNotifications: 'Notificações',
        obPowerNotificationsDesc: 'Alertas no horário certo',
        obPowerLocation: 'Localização',
        obPowerLocationDesc: 'Sugestões baseadas em onde você está',
        obPowerBiometrics: 'Biometria',
        obPowerBiometricsDesc: 'Proteja feitiços com digital ou rosto',
        obPowerShare: 'Compartilhar',
        obPowerShareDesc: 'Exporte e envie para amigos',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Abra outros apps diretamente',
        obPowerSensors: 'Sensores',
        obPowerSensorsDesc: 'Acesse bússola, acelerômetro e mais',
        obPowerHealth: 'Saúde',
        obPowerHealthDesc: 'Passos, calorias e dados de fitness',
        obPowerReceive: 'Receber Dados',
        obPowerReceiveDesc: "Aparece no 'Compartilhar' de outros apps",
        obPowerContacts: 'Contatos',
        obPowerContactsDesc: 'Selecione pessoas da sua agenda',
        obPowerDevice: 'Dispositivo',
        obPowerDeviceDesc: 'Vibração, idioma e info do sistema',
    ...
    es: {
        ...
        shortcutNudgeText: 'Abre directamente desde tu pantalla de inicio',
        ...
        obConceptPrompt: 'Quiero un timer Pomodoro con tema espacial 🚀',
        ...
        obPowersTitle2: 'superpoderes',
        obPowersSubtext: 'Además de IA, tus apps acceden a funciones reales de tu móvil.',
        obPowerCalendar: 'Calendario',
        obPowerCalendarDesc: 'Crea eventos y recordatorios automáticos',
        obPowerNotifications: 'Notificaciones',
        obPowerNotificationsDesc: 'Alertas en el momento justo',
        obPowerLocation: 'Ubicación',
        obPowerLocationDesc: 'Sugerencias basadas en dónde estás',
        obPowerBiometrics: 'Biometría',
        obPowerBiometricsDesc: 'Protege hechizos con huella o rostro',
        obPowerShare: 'Compartir',
        obPowerShareDesc: 'Exporta y envía a amigos',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Abre otras apps directamente',
        obPowerSensors: 'Sensores',
        obPowerSensorsDesc: 'Accede a la brújula, acelerómetro y más',
        obPowerHealth: 'Salud',
        obPowerHealthDesc: 'Pasos, calorías y datos de fitness',
        obPowerReceive: 'Recibir Datos',
        obPowerReceiveDesc: "Aparece en 'Compartilhar' desde otras apps",
        obPowerContacts: 'Contactos',
        obPowerContactsDesc: 'Selecciona personas de tu agenda',
        obPowerDevice: 'Dispositivo',
        obPowerDeviceDesc: 'Vibración, idioma e info del sistema',
    ...
    fr: {
        ...
        shortcutNudgeText: 'Ouvrez directement depuis l\'écran d\'accueil',
        ...
        obConceptPrompt: 'Je veux un timer Pomodoro thème spatial 🚀',
        ...
        obPowersSubtext: 'Au-delà de l\'IA, vos apps accèdent aux vrais capteurs de votre téléphone.',
        obPowerCalendar: 'Calendrier',
        obPowerCalendarDesc: 'Crée des événements et rappels automatiques',
        obPowerNotifications: 'Notifications',
        obPowerNotificationsDesc: 'Alertes au bon moment',
        obPowerLocation: 'Localisation',
        obPowerLocationDesc: 'Suggestions basées sur votre position',
        obPowerBiometrics: 'Biométrie',
        obPowerBiometricsDesc: 'Protégez vos sorts avec empreinte ou visage',
        obPowerShare: 'Partager',
        obPowerShareDesc: 'Exportez et envoyez à vos amis',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Ouvre d\'autres apps directement',
        obPowerSensors: 'Capteurs',
        obPowerSensorsDesc: 'Accédez à la boussole, l\'accéléromètre et plus encore',
        obPowerHealth: 'Santé',
        obPowerHealthDesc: 'Pas, calories et données de fitness',
        obPowerReceive: 'Recevoir des Données',
        obPowerReceiveDesc: "Apparaît dans 'Partager' depuis d'autres apps",
        obPowerContacts: 'Contacts',
        obPowerContactsDesc: 'Sélectionnez des personnes de votre répertoire',
        obPowerDevice: 'Appareil',
        obPowerDeviceDesc: 'Vibration, langue et infos système',
    ...
    de: {
        ...
        shortcutNudgeText: 'Direkt vom Startbildschirm öffnen',
        ...
        obConceptPrompt: 'Ich möchte einen Pomodoro-Timer mit Weltraumthema 🚀',
        ...
        obPowersSubtext: 'Neben KI greifen deine Apps auf echte Funktionen deines Handys zu.',
        obPowerCalendar: 'Kalender',
        obPowerCalendarDesc: 'Erstellt Termine und automatische Erinnerungen',
        obPowerNotifications: 'Benachrichtigungen',
        obPowerNotificationsDesc: 'Alerts zur richtigen Zeit',
        obPowerLocation: 'Standort',
        obPowerLocationDesc: 'Vorschläge basierend auf deinem Standort',
        obPowerBiometrics: 'Biometrie',
        obPowerBiometricsDesc: 'Schütze Zauber mit Fingerabdruck oder Gesicht',
        obPowerShare: 'Teilen',
        obPowerShareDesc: 'Exportiere und sende an Freunde',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Öffnet andere Apps direkt',
        obPowerSensors: 'Sensoren',
        obPowerSensorsDesc: 'Zugriff auf Kompass, Beschleunigungsmesser und mehr',
        obPowerHealth: 'Gesundheit',
        obPowerHealthDesc: 'Schritte, Kalorien und Fitnessdaten',
        obPowerReceive: 'Daten Empfangen',
        obPowerReceiveDesc: "Erscheint im 'Teilen' anderer Apps",
        obPowerContacts: 'Kontakte',
        obPowerContactsDesc: 'Personen aus deinem Kalender auswählen',
        obPowerDevice: 'Gerät',
        obPowerDeviceDesc: 'Vibration, Sprache und Systeminfos',
    ...
    it: {
        ...
        shortcutNudgeText: 'Apri direttamente dalla schermata iniziale',
        ...
        obConceptPrompt: 'Voglio un timer Pomodoro a tema spaziale 🚀',
        ...
        obPowersSubtext: 'Oltre all\'IA, le tue app accedono a funzioni reali del tuo telefono.',
        obPowerCalendar: 'Calendario',
        obPowerCalendarDesc: 'Crea eventi e promemoria automatici',
        obPowerNotifications: 'Notifiche',
        obPowerNotificationsDesc: 'Avvisi al momento giusto',
        obPowerLocation: 'Posizione',
        obPowerLocationDesc: 'Suggerimenti basati su dove ti trovi',
        obPowerBiometrics: 'Biometria',
        obPowerBiometricsDesc: 'Proteggi incantesimi con impronta o volto',
        obPowerShare: 'Condividi',
        obPowerShareDesc: 'Esporta e invia agli amici',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Apre altre app direttamente',
        obPowerSensors: 'Sensori',
        obPowerSensorsDesc: 'Accedi a bussola, accelerometro e altro',
        obPowerHealth: 'Salute',
        obPowerHealthDesc: 'Passi, calorie e dati fitness',
        obPowerReceive: 'Ricevi Dati',
        obPowerReceiveDesc: "Appare nel 'Condividi' di altre app",
        obPowerContacts: 'Contatti',
        obPowerContactsDesc: 'Seleziona persone dalla tua rubrica',
        obPowerDevice: 'Dispositivo',
        obPowerDeviceDesc: 'Vibrazione, lingua e info di sistema',
    ...
    ja: {
        ...
        obConceptPrompt: '宇宙テーマのポモドーロタイマーが欲しい 🚀',
        ...
        obPowersSubtext: 'AI以外にも、アプリはスマホの本物の機能にアクセスします。',
        obPowerCalendar: 'カレンダー',
        obPowerCalendarDesc: 'イベントと自動リマインダーを作成',
        obPowerNotifications: '通知',
        obPowerNotificationsDesc: '適切な時間にアラート',
        obPowerLocation: '位置情報',
        obPowerLocationDesc: '現在地に基づく提案',
        obPowerBiometrics: '生体認証',
        obPowerBiometricsDesc: '指紋や顔でスペルを保護',
        obPowerShare: '共有',
        obPowerShareDesc: 'エクスポートして友達に送信',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: '他のアプリを直接開く',
        obPowerSensors: 'センサー',
        obPowerSensorsDesc: 'コンパス、加速度計などにアクセスします',
        obPowerHealth: 'ヘルスケア',
        obPowerHealthDesc: '歩数、カロリー、フィットネスデータ',
        obPowerReceive: 'データ受信',
        obPowerReceiveDesc: '他のアプリの「共有」に表示されます',
        obPowerContacts: '連絡先',
        obPowerContactsDesc: 'アドレス帳から人を選択します',
        obPowerDevice: 'デバイス',
        obPowerDeviceDesc: 'バイブレーション、言語、システム情報',
    ...
    zh: {
        ...
        obPowersTitle2: '超能力',
        obPowersSubtext: '除了AI，你的应用还能访问手机的真实功能。',
        obPowerCalendar: '日历',
        obPowerCalendarDesc: '创建事件和自动提醒',
        obPowerNotifications: '通知',
        obPowerNotificationsDesc: '在合适的时间提醒',
        obPowerLocation: '位置',
        obPowerLocationDesc: '基于你所在位置的建议',
        obPowerBiometrics: '生物识别',
        obPowerBiometricsDesc: '用指纹或面部保护咒语',
        obPowerShare: '分享',
        obPowerShareDesc: '导出并发送给朋友',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: '直接打开其他应用',
        obPowerSensors: '传感器',
        obPowerSensorsDesc: '访问指南针、加速度计等',
        obPowerHealth: '健康',
        obPowerHealthDesc: '步数、卡路里和健身数据',
        obPowerReceive: '接收数据',
        obPowerReceiveDesc: '显示在其他应用的“分享”中',
        obPowerContacts: '联系人',
        obPowerContactsDesc: '从您的通讯录中选择联系人',
        obPowerDevice: '设备',
        obPowerDeviceDesc: '振动、语言和系统信息',
        obStartCTA: '开始创建咒语 🪄',
        obNextLabel: '下一步 ›',
    ...
    ko: {
        ...
        shortcutNudgeText: '홈 화면에서 바로 열기',
        ...
        obConceptPrompt: '우주 테마 포모도로 타이머를 원해요 🚀',
        ...
        obPowersSubtext: 'AI 외에도 앱이 휴대폰의 실제 기능에 접근합니다.',
        obPowerCalendar: '캘린더',
        obPowerCalendarDesc: '이벤트와 자동 알림 생성',
        obPowerNotifications: '알림',
        obPowerNotificationsDesc: '적절한 시간에 알림',
        obPowerLocation: '위치',
        obPowerLocationDesc: '현재 위치 기반 제안',
        obPowerBiometrics: '생체인증',
        obPowerBiometricsDesc: '지문이나 얼굴로 스펠 보호',
        obPowerShare: '공유',
        obPowerShareDesc: '내보내기 후 친구에게 전송',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: '다른 앱을 직접 열기',
        obPowerSensors: '센서',
        obPowerSensorsDesc: '나침반, 가속도계 등에 액세스',
        obPowerHealth: '건강',
        obPowerHealthDesc: '걸음 수, 칼로리 및 피트니스 데이터',
        obPowerReceive: '데이터 수신',
        obPowerReceiveDesc: "다른 앱의 '공유'에 표시됨",
        obPowerContacts: '연락처',
        obPowerContactsDesc: '주소록에서 사람 선택',
        obPowerDevice: '기기',
        obPowerDeviceDesc: '진동, 언어 및 시스템 정보',
    ...
    ar: {
        ...
        shortcutNudgeText: 'افتح مباشرة من الشاشة الرئيسية',
        ...
        obConceptPrompt: 'أريد مؤقت بومودورو بطابع فضائي 🚀',
        ...
        obPowersSubtext: 'بالإضافة للذكاء الاصطناعي، تطبيقاتك تستخدم ميزات حقيقية من هاتفك.',
        obPowerCalendar: 'التقويم',
        obPowerCalendarDesc: 'ينشئ أحداث وتذكيرات تلقائية',
        obPowerNotifications: 'الإشعارات',
        obPowerNotificationsDesc: 'تنبيهات في الوقت المناسب',
        obPowerLocation: 'الموقع',
        obPowerLocationDesc: 'اقتراحات بناءً على مكانك',
        obPowerBiometrics: 'البيومترية',
        obPowerBiometricsDesc: 'احمِ التعويذات ببصمة أو وجه',
        obPowerShare: 'مشاركة',
        obPowerShareDesc: 'صدّر وأرسل للأصدقاء',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'يفتح تطبيقات أخرى مباشرة',
        obPowerSensors: 'المستشعرات',
        obPowerSensorsDesc: 'الوصول إلى البوصلة، مقياس التسارع والمزيد',
        obPowerHealth: 'الصحة',
        obPowerHealthDesc: 'الخطوات، السعرات الحرارية وبيانات اللياقة',
        obPowerReceive: 'استلام البيانات',
        obPowerReceiveDesc: "يظهر في 'مشاركة' من التطبيقات الأخرى",
        obPowerContacts: 'جهات الاتصال',
        obPowerContactsDesc: 'اختر أشخاصاً من أجندتك',
        obPowerDevice: 'الجهاز',
        obPowerDeviceDesc: 'الاهتزاز، اللغة ومعلومات النظام',
    ...
    hi: {
        ...
        shortcutNudgeText: 'होम स्क्रीन से सीधे खोलें',
        ...
        obConceptPrompt: 'मुझे स्पेस थीम का पोमोडोरो टाइमर चाहिए 🚀',
        ...
        obPowersSubtext: 'AI के अलावा, आपकी ऐप्स फोन की असली सुविधाएं इस्तेमाल करती हैं।',
        obPowerCalendar: 'कैलेंडर',
        obPowerCalendarDesc: 'इवेंट और ऑटो रिमाइंडर बनाता है',
        obPowerNotifications: 'नोटिफिकेशन',
        obPowerNotificationsDesc: 'सही समय पर अलर्ट',
        obPowerLocation: 'लोकेशन',
        obPowerLocationDesc: 'आपकी जगह के आधार पर सुझाव',
        obPowerBiometrics: 'बायोमेट्रिक',
        obPowerBiometricsDesc: 'फिंगरप्रिंट या चेहरे से स्पेल सुरक्षित करें',
        obPowerShare: 'शेयर',
        obPowerShareDesc: 'एक्सपोर्ट करें और दोस्तों को भेजें',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'अन्य ऐप्स सीधे खोलें',
        obPowerSensors: 'सेंसर',
        obPowerSensorsDesc: 'कम्पास, एक्सेलेरोमीटर और बहुत कुछ तक पहुँचें',
        obPowerHealth: 'स्वास्थ्य',
        obPowerHealthDesc: 'कदम, कैलोरी और फिटनेस डेटा',
        obPowerReceive: 'डेटा प्राप्त करें',
        obPowerReceiveDesc: "अन्य ऐप्स से 'शेयर' में दिखाई देता है",
        obPowerContacts: 'संपर्क',
        obPowerContactsDesc: 'अपने एजेंडे से लोगों को चुनें',
        obPowerDevice: 'डिवाइस',
        obPowerDeviceDesc: 'वाइब्रेशन, भाषा और सिस्टम की जानकारी',
    ...
    ru: {
        ...
        shortcutNudgeText: 'Открыть прямо с главного экрана',
        ...
        obConceptPrompt: 'Хочу Помодоро-таймер в космической теме 🚀',
        ...
        obPowersSubtext: 'Помимо ИИ, ваши приложения используют реальные функции телефона.',
        obPowerCalendar: 'Календарь',
        obPowerCalendarDesc: 'Создаёт события и автоматические напоминания',
        obPowerNotifications: 'Уведомления',
        obPowerNotificationsDesc: 'Оповещения в нужное время',
        obPowerLocation: 'Геолокация',
        obPowerLocationDesc: 'Предложения на основе вашего местоположения',
        obPowerBiometrics: 'Биометрия',
        obPowerBiometricsDesc: 'Защитите заклинания отпечатком или лицом',
        obPowerShare: 'Поделиться',
        obPowerShareDesc: 'Экспортируйте и отправьте друзьям',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Открывает другие приложения напрямую',
        obPowerSensors: 'Датчики',
        obPowerSensorsDesc: 'Доступ к компасу, акселерометру и другому',
        obPowerHealth: 'Здоровье',
        obPowerHealthDesc: 'Шаги, калории и данные о фитнесе',
        obPowerReceive: 'Получение данных',
        obPowerReceiveDesc: "Появляется в 'Поделиться' из других приложений",
        obPowerContacts: 'Контакты',
        obPowerContactsDesc: 'Выбор людей из вашей книги',
        obPowerDevice: 'Устройство',
        obPowerDeviceDesc: 'Вибрация, язык и системная информация',
    ...
    tr: {
        ...
        shortcutNudgeText: 'Ana ekrandan doğrudan açın',
        ...
        obConceptPrompt: 'Uzay temalı bir Pomodoro zamanlayıcı istiyorum 🚀',
        ...
        obPowersSubtext: 'AI dışında uygulamalarınız telefonunuzun gerçek özelliklerine erişir.',
        obPowerCalendar: 'Takvim',
        obPowerCalendarDesc: 'Etkinlikler ve otomatik hatırlatıcılar oluşturur',
        obPowerNotifications: 'Bildirimler',
        obPowerNotificationsDesc: 'Doğru zamanda uyarılar',
        obPowerLocation: 'Konum',
        obPowerLocationDesc: 'Bulunduğunuz yere göre öneriler',
        obPowerBiometrics: 'Biyometri',
        obPowerBiometricsDesc: 'Büyüleri parmak izi veya yüzle koruyun',
        obPowerShare: 'Paylaş',
        obPowerShareDesc: 'Dışa aktarın ve arkadaşlara gönderin',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Diğer uygulamaları doğrudan açar',
        obPowerSensors: 'Sensörler',
        obPowerSensorsDesc: 'Pusula, ivmeölçer ve daha fazlasına erişin',
        obPowerHealth: 'Sağlık',
        obPowerHealthDesc: 'Adımlar, kaloriler ve fitness verileri',
        obPowerReceive: 'Veri Al',
        obPowerReceiveDesc: "Diğer uygulamaların 'Paylaş' menüsünde görünür",
        obPowerContacts: 'Kişiler',
        obPowerContactsDesc: 'Rehberinizden kişileri seçin',
        obPowerDevice: 'Cihaz',
        obPowerDeviceDesc: 'Titreşim, dil ve sistem bilgileri',
    ...
    nl: {
        ...
        shortcutNudgeText: 'Open direct vanuit je startscherm',
        ...
        obConceptPrompt: 'Ik wil een Pomodoro-timer met ruimtethema 🚀',
        ...
        obPowersSubtext: 'Naast AI hebben je apps toegang tot echte functies van je telefoon.',
        obPowerCalendar: 'Agenda',
        obPowerCalendarDesc: 'Maakt afspraken en automatische herinneringen',
        obPowerNotifications: 'Meldingen',
        obPowerNotificationsDesc: 'Meldingen op het juiste moment',
        obPowerLocation: 'Locatie',
        obPowerLocationDesc: 'Suggesties op basis van je locatie',
        obPowerBiometrics: 'Biometrie',
        obPowerBiometricsDesc: 'Bescherm spreuken met vingerafdruk of gezicht',
        obPowerShare: 'Delen',
        obPowerShareDesc: 'Exporteer en stuur naar vrienden',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Opent andere apps direct',
        obPowerSensors: 'Sensoren',
        obPowerSensorsDesc: 'Toegang tot kompas, versnellingsmeter en meer',
        obPowerHealth: 'Gezondheid',
        obPowerHealthDesc: 'Stappen, calorieën en fitnessgegevens',
        obPowerReceive: 'Gegevens Ontvangen',
        obPowerReceiveDesc: "Verschijnt in 'Delen' vanuit andere apps",
        obPowerContacts: 'Contacten',
        obPowerContactsDesc: 'Selecteer personen uit je agenda',
        obPowerDevice: 'Apparaat',
        obPowerDeviceDesc: 'Trillingen, taal en systeeminformatie',
    ...
    pl: {
        ...
        shortcutNudgeText: 'Otwórz bezpośrednio z ekranu głównego',
        ...
        obConceptPrompt: 'Chcę timer Pomodoro z motywem kosmicznym 🚀',
        ...
        obPowersSubtext: 'Poza AI, twoje aplikacje korzystają z prawdziwych funkcji telefonu.',
        obPowerCalendar: 'Kalendarz',
        obPowerCalendarDesc: 'Tworzy wydarzenia i automatyczne przypomnienia',
        obPowerNotifications: 'Powiadomienia',
        obPowerNotificationsDesc: 'Alerty we właściwym czasie',
        obPowerLocation: 'Lokalizacja',
        obPowerLocationDesc: 'Sugestie oparte na twojej lokalizacji',
        obPowerBiometrics: 'Biometria',
        obPowerBiometricsDesc: 'Chroń czary odciskiem lub twarzą',
        obPowerShare: 'Udostępnij',
        obPowerShareDesc: 'Eksportuj i wyślij do znajomych',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Otwiera inne aplikacje bezpośrednio',
        obPowerSensors: 'Czujniki',
        obPowerSensorsDesc: 'Dostęp do kompasu, akcelerometru i innych',
        obPowerHealth: 'Zdrowie',
        obPowerHealthDesc: 'Kroki, kalorie i dane fitness',
        obPowerReceive: 'Odbieranie Danych',
        obPowerReceiveDesc: "Pojawia się w 'Udostępnij' z innych aplikacji",
        obPowerContacts: 'Kontakty',
        obPowerContactsDesc: 'Wybierz osoby ze swojej książki adresowej',
        obPowerDevice: 'Urządzenie',
        obPowerDeviceDesc: 'Wibracje, język i informacje o systemie',
    ...
    vi: {
        ...
        shortcutNudgeText: 'Mở trực tiếp từ màn hình chính',
        ...
        obConceptPrompt: 'Tôi muốn đồng hồ Pomodoro chủ đề vũ trụ 🚀',
        ...
        obPowersSubtext: 'Ngoài AI, ứng dụng truy cập các tính năng thực trên điện thoại.',
        obPowerCalendar: 'Lịch',
        obPowerCalendarDesc: 'Tạo sự kiện và nhắc nhở tự động',
        obPowerNotifications: 'Thông báo',
        obPowerNotificationsDesc: 'Cảnh báo đúng lúc',
        obPowerLocation: 'Vị trí',
        obPowerLocationDesc: 'Gợi ý dựa trên vị trí của bạn',
        obPowerBiometrics: 'Sinh trắc học',
        obPowerBiometricsDesc: 'Bảo vệ phép thuật bằng vân tay hoặc khuôn mặt',
        obPowerShare: 'Chia sẻ',
        obPowerShareDesc: 'Xuất và gửi cho bạn bè',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Mở ứng dụng khác trực tiếp',
        obPowerSensors: 'Cảm biến',
        obPowerSensorsDesc: 'Truy cập la bàn, gia tốc kế và hơn thế nữa',
        obPowerHealth: 'Sức khỏe',
        obPowerHealthDesc: 'Số bước, calo và dữ liệu thể dục',
        obPowerReceive: 'Nhận dữ liệu',
        obPowerReceiveDesc: "Xuất hiện trong phần 'Chia sẻ' từ các ứng dụng khác",
        obPowerContacts: 'Danh bạ',
        obPowerContactsDesc: 'Chọn mọi người từ danh bạ của bạn',
        obPowerDevice: 'Thiết bị',
        obPowerDeviceDesc: 'Rung, ngôn ngữ và thông tin hệ thống',
    ...
    th: {
        ...
        shortcutNudgeText: 'เปิดโดยตรงจากหน้าจอหลัก',
        ...
        obConceptPrompt: 'อยากได้ Pomodoro Timer ธีมอวกาศ 🚀',
        ...
        obPowersSubtext: 'นอกจาก AI แอปของคุณเข้าถึงฟีเจอร์จริงของโทรศัพท์',
        obPowerCalendar: 'ปฏิทิน',
        obPowerCalendarDesc: 'สร้างกิจกรรมและการเตือนอัตโนมัติ',
        obPowerNotifications: 'การแจ้งเตือน',
        obPowerNotificationsDesc: 'แจ้งเตือนในเวลาที่เหมาะสม',
        obPowerLocation: 'ตำแหน่ง',
        obPowerLocationDesc: 'คำแนะนำตามตำแหน่งของคุณ',
        obPowerBiometrics: 'ไบโอเมตริก',
        obPowerBiometricsDesc: 'ป้องกันคาถาด้วยลายนิ้วมือหรือใบหน้า',
        obPowerShare: 'แชร์',
        obPowerShareDesc: 'ส่งออกและส่งให้เพื่อน',
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'เปิดแอปอื่นโดยตรง',
        obPowerSensors: 'เซนเซอร์',
        obPowerSensorsDesc: 'เข้าถึงเข็มทิศ มาตรวัดความเร่ง และอื่นๆ',
        obPowerHealth: 'สุขภาพ',
        obPowerHealthDesc: 'จำนวนก้าว แคลอรี่ และข้อมูลการออกกำลังกาย',
        obPowerReceive: 'รับข้อมูล',
        obPowerReceiveDesc: "ปรากฏในเมนู 'แชร์' จากแอปอื่น",
        obPowerContacts: 'รายชื่อติดต่อ',
        obPowerContactsDesc: 'เลือกบุคคลจากสมุดรายชื่อของคุณ',
        obPowerDevice: 'อุปกรณ์',
        obPowerDeviceDesc: 'การสั่น ภาษา และข้อมูลระบบ',
