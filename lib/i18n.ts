...
const translations = {
    en: {
        ...
        obConceptSubtext: 'No code. No setup. Each "spell" is a mini-app built exactly for you.',
        ...
        obTryTitle2: 'you',
        obTryTitle3: 'try it.',
        obTrySubtext: 'Tap a suggestion or write what you need. Takes seconds.',
        obTryPlaceholder: 'What do you need?',
        obChipShopping: 'Shopping list',
        obChipDiary: 'Mood diary',
        obChipWorkout: 'Gym workout',
        obChipExpenses: 'Monthly expenses',
        obChipShoppingFull: 'Smart shopping list 🛒',
        obChipDiaryFull: 'Daily mood diary 📓',
        obChipWorkoutFull: 'Personalized gym workout 💪',
        obChipExpensesFull: 'Monthly expense tracker 💰',
    ...
    pt: {
        ...
        obConceptSubtext: 'Sem código. Sem configuração. Cada "feitiço" é um mini-app criado exatamente para você.',
        ...
        obTryTitle2: 'você',
        obTryTitle3: 'tenta.',
        obTrySubtext: 'Toque em uma sugestão ou escreva o que precisa. Leva segundos.',
        obTryPlaceholder: 'O que você precisa?',
        obChipShopping: 'Lista de compras',
        obChipDiary: 'Diário de humor',
        obChipWorkout: 'Treino academia',
        obChipExpenses: 'Gastos do mês',
        obChipShoppingFull: 'Lista de compras inteligente 🛒',
        obChipDiaryFull: 'Diário de humor diário 📓',
        obChipWorkoutFull: 'Treino de academia personalizado 💪',
        obChipExpensesFull: 'Controlador de gastos do mês 💰',
        ...
        obPowerDeeplinks: 'WhatsApp+',
        obPowerDeeplinksDesc: 'Abre outros apps diretamente',
    ...
    es: {
        ...
        obConceptSubtext: 'Sin código. Sin configuración. Cada "hechizo" es una mini-app creada exactamente para ti.',
        obConceptPrompt: 'Quiero un timer Pomodoro con tema espacial 🚀',
        obConceptCreated: '✓ Hechizo creado en ~1 min',
        obTryTitle1: 'Ahora',
        obTryTitle2: 'tú',
        obTryTitle3: 'intentas.',
        obTrySubtext: 'Toca una sugerencia o escribe lo que necesitas. Solo toma segundos.',
        obTryPlaceholder: '¿Qué necesitas?',
        obChipShopping: 'Lista de compras',
        obChipDiary: 'Diario de ánimo',
        obChipWorkout: 'Rutina gym',
        obChipExpenses: 'Gastos del mes',
        obChipShoppingFull: 'Lista de compras inteligente 🛒',
        obChipDiaryFull: 'Diario de ánimo diario 📓',
        obChipWorkoutFull: 'Rutina de gym personalizada 💪',
        obChipExpensesFull: 'Control de gastos del mes 💰',
        tplShoppingTitle: 'Lista de Compras',
    ...
    fr: {
        ...
        obConceptSubtext: 'Sans code. Sans config. Chaque "sort" est une mini-app créée exactement pour vous.',
        obConceptPrompt: 'Je veux un timer Pomodoro thème spatial 🚀',
        obConceptCreated: '✓ Sort créé en ~1 min',
        obTryTitle1: 'Maintenant',
        obTryTitle2: 'vous',
        obTryTitle3: 'essayez.',
        obTrySubtext: 'Touchez une suggestion ou écrivez ce dont vous avez besoin. Quelques secondes.',
        obTryPlaceholder: 'De quoi avez-vous besoin ?',
        obChipShopping: 'Liste de courses',
        obChipDiary: 'Journal d\'humeur',
        obChipWorkout: 'Entraînement',
        obChipExpenses: 'Dépenses du mois',
        obChipShoppingFull: 'Liste de courses intelligente 🛒',
        obChipDiaryFull: 'Journal d\'humeur quotidien 📓',
        obChipWorkoutFull: 'Entraînement personnalisé 💪',
        obChipExpensesFull: 'Suivi des dépenses du mois 💰',
    ...
    de: {
        ...
        obConceptSubtext: 'Kein Code. Keine Einrichtung. Jeder "Zauber" ist eine Mini-App, maßgeschneidert für dich.',
        ...
        obTrySubtext: 'Tippe auf einen Vorschlag oder schreibe, was du brauchst. Dauert Sekunden.',
        obTryPlaceholder: 'Was brauchst du?',
        obChipShopping: 'Einkaufsliste',
        obChipDiary: 'Stimmungstagebuch',
        obChipWorkout: 'Gym-Training',
        obChipExpenses: 'Monatsausgaben',
        obChipShoppingFull: 'Smarte Einkaufsliste 🛒',
        obChipDiaryFull: 'Tägliches Stimmungstagebuch 📓',
        obChipWorkoutFull: 'Personalisiertes Gym-Training 💪',
        obChipExpensesFull: 'Monatlicher Ausgabentracker 💰',
    ...
    it: {
        ...
        obConceptSubtext: 'Nessun codice. Nessuna configurazione. Ogni "incantesimo" è una mini-app creata per te.',
        obConceptPrompt: 'Voglio un timer Pomodoro a tema spaziale 🚀',
        obConceptCreated: '✓ Incantesimo creato in ~1 min',
        obTryTitle1: 'Ora',
        obTryTitle2: 'prova',
        obTryTitle3: 'tu.',
        obTrySubtext: 'Tocca un suggerimento o scrivi cosa ti serve. Bastano secondi.',
        obTryPlaceholder: 'Di cosa hai bisogno?',
        obChipShopping: 'Lista della spesa',
        obChipDiary: 'Diario dell\'umore',
        obChipWorkout: 'Allenamento',
        obChipExpenses: 'Spese del mese',
        obChipShoppingFull: 'Lista della spesa intelligente 🛒',
        obChipDiaryFull: 'Diario dell\'umore quotidiano 📓',
        obChipWorkoutFull: 'Allenamento personalizzato 💪',
        obChipExpensesFull: 'Tracker spese del mese 💰',
    ...
    ja: {
        ...
        obConceptTitle3: '数秒で。',
        obConceptSubtext: 'コード不要。設定不要。各「スペル」はあなた専用のミニアプリです。',
        obConceptPrompt: '宇宙テーマのポモドーロタイマーが欲しい 🚀',
        obConceptCreated: '✓ 約1分でスペル作成',
        obTryTitle1: 'さあ',
        obTryTitle2: 'あなたが',
        obTryTitle3: '試して。',
        obTrySubtext: '提案をタップするか、必要なものを書いてください。数秒です。',
        obTryPlaceholder: '何が必要ですか？',
        obChipShopping: '買い物リスト',
        obChipDiary: '気分日記',
        obChipWorkout: 'ジムトレ',
        obChipExpenses: '月の支出',
        obChipShoppingFull: 'スマート買い物リスト 🛒',
        obChipDiaryFull: '毎日の気分日記 📓',
        obChipWorkoutFull: 'パーソナルジムトレーニング 💪',
        obChipExpensesFull: '月間支出トラッカー 💰',
    ...
    zh: {
        ...
        obConceptTitle3: '几秒钟。',
        obConceptSubtext: '无需代码。无需配置。每个"咒语"都是专为你打造的迷你应用。',
        obConceptPrompt: '我想要一个太空主题的番茄钟 🚀',
        obConceptCreated: '✓ 约1分钟创建咒语',
        obTryTitle1: '现在',
        obTryTitle2: '你',
        obTryTitle3: '来试试。',
        obTrySubtext: '点击建议或写下你需要的。只需几秒。',
        obTryPlaceholder: '你需要什么？',
        obChipShopping: '购物清单',
        obChipDiary: '心情日记',
        obChipWorkout: '健身训练',
        obChipExpenses: '月度开支',
        obChipShoppingFull: '智能购物清单 🛒',
        obChipDiaryFull: '每日心情日记 📓',
        obChipWorkoutFull: '个性化健身训练 💪',
        obChipExpensesFull: '月度开支追踪器 💰',
    ...
    ko: {
        ...
        obConceptSubtext: '코드 없이. 설정 없이. 각 "스펠"은 당신만을 위한 미니앱입니다.',
        obConceptPrompt: '우주 테마 포모도로 타이머를 원해요 🚀',
        obConceptCreated: '✓ 약 1분 만에 스펠 생성',
        obTryTitle1: '이제',
        obTryTitle2: '당신이',
        obTryTitle3: '해보세요.',
        obTrySubtext: '제안을 탭하거나 필요한 것을 쓰세요. 몇 초면 됩니다.',
        obTryPlaceholder: '무엇이 필요하세요?',
        obChipShopping: '장보기 목록',
        obChipDiary: '기분 일기',
        obChipWorkout: '헬스 운동',
        obChipExpenses: '월별 지출',
        obChipShoppingFull: '스마트 장보기 목록 🛒',
        obChipDiaryFull: '매일 기분 일기 📓',
        obChipWorkoutFull: '맞춤 헬스 운동 💪',
        obChipExpensesFull: '월별 지출 추적기 💰',
    ...
    ar: {
        ...
        obConceptSubtext: 'بدون كود. بدون إعداد. كل "تعويذة" هي تطبيق مصغر مصنوع خصيصاً لك.',
        obConceptPrompt: 'أريد مؤقت بومودورو بطابع فضائي 🚀',
        obConceptCreated: '✓ تعويذة تم إنشاؤها في ~1 دقيقة',
        obTryTitle1: 'الآن',
        obTryTitle2: 'أنت',
        obTryTitle3: 'جرّب.',
        obTrySubtext: 'اضغط على اقتراح أو اكتب ما تحتاجه. يستغرق ثوانٍ فقط.',
        obTryPlaceholder: 'ماذا تحتاج؟',
        obChipShopping: 'قائمة تسوق',
        obChipDiary: 'يوميات المزاج',
        obChipWorkout: 'تمرين رياضي',
        obChipExpenses: 'مصاريف الشهر',
        obChipShoppingFull: 'قائمة تسوق ذكية 🛒',
        obChipDiaryFull: 'يوميات المزاج اليومية 📓',
        obChipWorkoutFull: 'تمرين رياضي مخصص 💪',
        obChipExpensesFull: 'متتبع مصاريف الشهر 💰',
    ...
    hi: {
        ...
        obConceptSubtext: 'कोई कोड नहीं। कोई सेटअप नहीं। हर "स्पेल" आपके लिए बनी एक मिनी-ऐप है।',
        obConceptPrompt: 'मुझे स्पेस थीम का पोमोडोरो टाइमर चाहिए 🚀',
        obConceptCreated: '✓ ~1 मिनट में स्पेल बना',
        obTryTitle1: 'अब',
        obTryTitle2: 'आप',
        obTryTitle3: 'करें।',
        obTrySubtext: 'सुझाव पर टैप करें या लिखें कि क्या चाहिए। बस कुछ सेकंड।',
        obTryPlaceholder: 'आपको क्या चाहिए?',
        obChipShopping: 'खरीदारी सूची',
        obChipDiary: 'मूड डायरी',
        obChipWorkout: 'जिम वर्कआउट',
        obChipExpenses: 'मासिक खर्च',
        obChipShoppingFull: 'स्मार्ट खरीदारी सूची 🛒',
        obChipDiaryFull: 'दैनिक मूड डायरी 📓',
        obChipWorkoutFull: 'पर्सनल जिम वर्कआउट 💪',
        obChipExpensesFull: 'मासिक खर्च ट्रैकर 💰',
    ...
    ru: {
        ...
        obConceptSubtext: 'Без кода. Без настройки. Каждое "заклинание" — мини-приложение, созданное для вас.',
        ...
        obTrySubtext: 'Нажмите на предложение или напишите, что нужно. Это займёт секунды.',
        obTryPlaceholder: 'Что вам нужно?',
        obChipShopping: 'Список покупок',
        obChipDiary: 'Дневник настроения',
        obChipWorkout: 'Тренировка',
        obChipExpenses: 'Расходы за месяц',
        obChipShoppingFull: 'Умный список покупок 🛒',
        obChipDiaryFull: 'Ежедневный дневник настроения 📓',
        obChipWorkoutFull: 'Персональная тренировка 💪',
        obChipExpensesFull: 'Трекер расходов за месяц 💰',
    ...
    tr: {
        ...
        obConceptSubtext: 'Kod yok. Kurulum yok. Her "büyü" tam size göre bir mini uygulama.',
        obConceptPrompt: 'Uzay temalı bir Pomodoro zamanlayıcı istiyorum 🚀',
        obConceptCreated: '✓ ~1 dakikada büyü oluşturuldu',
        obTryTitle1: 'Şimdi',
        obTryTitle2: 'siz',
        obTryTitle3: 'deneyin.',
        obTrySubtext: 'Bir öneriye dokunun veya neye ihtiyacınız olduğunu yazın. Saniyeler sürer.',
        obTryPlaceholder: 'Neye ihtiyacınız var?',
        obChipShopping: 'Alışveriş listesi',
        obChipDiary: 'Ruh hali günlüğü',
        obChipWorkout: 'Spor antrenmanı',
        obChipExpenses: 'Aylık harcamalar',
        obChipShoppingFull: 'Akıllı alışveriş listesi 🛒',
        obChipDiaryFull: 'Günlük ruh hali günlüğü 📓',
        obChipWorkoutFull: 'Kişiselleştirilmiş antrenman 💪',
        obChipExpensesFull: 'Aylık harcama takipçisi 💰',
    ...
    nl: {
        ...
        obConceptSubtext: 'Geen code. Geen configuratie. Elke "spreuk" is een mini-app speciaal voor jou.',
        obConceptPrompt: 'Ik wil een Pomodoro-timer met ruimtethema 🚀',
        obConceptCreated: '✓ Spreuk gemaakt in ~1 min',
        obTryTitle1: 'Nu',
        obTryTitle2: 'jij',
        obTryTitle3: 'probeert.',
        obTrySubtext: 'Tik op een suggestie of schrijf wat je nodig hebt. Duurt seconden.',
        obTryPlaceholder: 'Wat heb je nodig?',
        obChipShopping: 'Boodschappenlijst',
        obChipDiary: 'Stemmingsdagboek',
        obChipWorkout: 'Sportroutine',
        obChipExpenses: 'Maanduitgaven',
        obChipShoppingFull: 'Slimme boodschappenlijst 🛒',
        obChipDiaryFull: 'Dagelijks stemmingsdagboek 📓',
        obChipWorkoutFull: 'Gepersonaliseerde sportroutine 💪',
        obChipExpensesFull: 'Maandelijkse uitgaventracker 💰',
    ...
    pl: {
        ...
        obConceptSubtext: 'Bez kodu. Bez konfiguracji. Każdy "czar" to mini-aplikacja stworzona dla ciebie.',
        obConceptPrompt: 'Chcę timer Pomodoro z motywem kosmicznym 🚀',
        obConceptCreated: '✓ Czar stworzony w ~1 min',
        obTryTitle1: 'Teraz',
        obTryTitle2: 'ty',
        obTryTitle3: 'spróbuj.',
        obTrySubtext: 'Dotknij sugestii lub napisz, czego potrzebujesz. Zajmie sekundy.',
        obTryPlaceholder: 'Czego potrzebujesz?',
        obChipShopping: 'Lista zakupów',
        obChipDiary: 'Dziennik nastroju',
        obChipWorkout: 'Trening',
        obChipExpenses: 'Wydatki miesiąca',
        obChipShoppingFull: 'Inteligentna lista zakupów 🛒',
        obChipDiaryFull: 'Codzienny dziennik nastroju 📓',
        obChipWorkoutFull: 'Spersonalizowany trening 💪',
        obChipExpensesFull: 'Tracker wydatków miesiąca 💰',
    ...
    vi: {
        ...
        obConceptSubtext: 'Không cần code. Không cần cài đặt. Mỗi "phép thuật" là một mini-app được tạo riêng cho bạn.',
        obConceptPrompt: 'Tôi muốn đồng hồ Pomodoro chủ đề vũ trụ 🚀',
        obConceptCreated: '✓ Phép thuật tạo trong ~1 phút',
        obTryTitle1: 'Giờ',
        obTryTitle2: 'bạn',
        obTryTitle3: 'thử nhé.',
        obTrySubtext: 'Chạm vào gợi ý hoặc viết những gì bạn cần. Chỉ mất vài giây.',
        obTryPlaceholder: 'Bạn cần gì?',
        obChipShopping: 'Danh sách mua sắm',
        obChipDiary: 'Nhật ký tâm trạng',
        obChipWorkout: 'Tập gym',
        obChipExpenses: 'Chi tiêu tháng',
        obChipShoppingFull: 'Danh sách mua sắm thông minh 🛒',
        obChipDiaryFull: 'Nhật ký tâm trạng hàng ngày 📓',
        obChipWorkoutFull: 'Bài tập gym cá nhân 💪',
        obChipExpensesFull: 'Theo dõi chi tiêu tháng 💰',
    ...
    th: {
        ...
        obConceptSubtext: 'ไม่ต้องเขียนโค้ด ไม่ต้องตั้งค่า ทุก "คาถา" คือมินิแอปที่สร้างมาเพื่อคุณ',
        obConceptPrompt: 'อยากได้ Pomodoro Timer ธีมอวกาศ 🚀',
        obConceptCreated: '✓ สร้างคาถาใน ~1 นาที',
        obTryTitle1: 'ตอนนี้',
        obTryTitle2: 'คุณ',
        obTryTitle3: 'ลองดู',
        obTrySubtext: 'แตะคำแนะนำหรือเขียนสิ่งที่คุณต้องการ ใช้เวลาไม่กี่วินาที',
        obTryPlaceholder: 'คุณต้องการอะไร?',
        obChipShopping: 'รายการซื้อของ',
        obChipDiary: 'ไดอารี่อารมณ์',
        obChipWorkout: 'ออกกำลังกาย',
        obChipExpenses: 'รายจ่ายเดือน',
        obChipShoppingFull: 'รายการซื้อของอัจฉริยะ 🛒',
        obChipDiaryFull: 'ไดอารี่อารมณ์ประจำวัน 📓',
        obChipWorkoutFull: 'ออกกำลังกายส่วนตัว 💪',
        obChipExpensesFull: 'ติดตามรายจ่ายรายเดือน 💰',
