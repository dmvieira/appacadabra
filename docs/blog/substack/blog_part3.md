<!--
  ...
  =========================
  Title: The UX/Product Department. Fast UI Mockups with Agents
  Subtitle: How the browser became my mobile prototype lab -- and why every mockup got validated before a single line of native code.
  Source: docs/blog/blog_expanded_parts1_3.md (Part 3)
...
The result was a fully interactive prototype running in Chrome. No Gradle build. No Android emulator startup time (which, on a mid-tier development machine, can easily consume 3 to 5 minutes per cycle). No APK installation. Just a browser tab.
...
**[INSERT IMAGE: ux_pipeline_flowchart.png]**
